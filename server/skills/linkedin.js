...
const SCRIPTS_LINKEDIN = {
  medico_cirurgiao: {
    convite: 'Dr(a). {nome}, acompanho profissionais da sua área que construíram patrimônio relevante e raramente têm tempo de estruturá-lo. Trabalho com Relações Institucionais na Altum Wealth e gostaria de conectar.',
    1: `{nome}, obrigada por aceitar. Sou Sofia Mendes, das Relações Institucionais da Altum Wealth — trabalho com Hariton Andrade, advisor independente no modelo fiduciário (sem comissão de produto).
...
Vou deixar a porta aberta: quando quiser uma segunda opinião independente sobre como proteger o que construiu, é só me chamar. Sigo à disposição.`
  ...
  advogado_tributarista: {
    convite: '{nome}, você estrutura patrimônio complexo com maestria todos os dias. Trabalho com Relações Institucionais na Altum Wealth, no modelo fiduciário independente, e seria um prazer conectar.',
    1: `{nome}, obrigada pela conexão. Sou Sofia Mendes, das Relações Institucionais da Altum Wealth — atuo com Hariton Andrade, advisor independente, modelo fiduciário sem comissão de produto.
...
Fica o convite em aberto: quando fizer sentido revisar a sua estrutura pessoal com um olhar independente, é só me chamar.`
  ...
  ceo_empresario: {
    convite: '{nome}, admiro o que você construiu. Trabalho com Relações Institucionais na Altum Wealth — modelo fiduciário independente — com empresários que pensam a proteção do patrimônio pessoal. Vamos conectar?',
    1: `{nome}, obrigada por aceitar. Sou Sofia Mendes, das Relações Institucionais da Altum Wealth — trabalho com Hariton Andrade, advisor independente, remuneração 100% alinhada ao cliente, sem comissão de produto.
...
Quando quiser dar esse próximo passo com uma visão independente, é só me chamar. Sigo à disposição.`
  ...
  dentista_especialista: {
    convite: '{nome}, acompanho especialistas que construíram patrimônio relevante e querem que ele trabalhe com a mesma eficiência da carreira. Sou das Relações Institucionais da Altum Wealth — vamos conectar?',
    1: `{nome}, obrigada pela conexão. Sou Sofia Mendes, das Relações Institucionais da Altum Wealth — atuo com Hariton Andrade, advisor independente no modelo fiduciário, sem comissão de produto.
...
Deixo a porta aberta.`
  ...
  engenheiro_executivo: {
    convite: '{nome}, trabalho com executivos sênior que acumularam patrimônio relevante — muitas vezes concentrado na própria empresa. Sou das Relações Institucionais da Altum Wealth. Seria um prazer conectar.',
    1: `{nome}, obrigada por aceitar. Sou Sofia Mendes, das Relações Institucionais da Altum Wealth — trabalho com Hariton Andrade, advisor independente, modelo fiduciário sem comissão de produto.
...
Quando o momento for certo para diversificar com um olhar independente, é só me chamar.`
  ...
  universal: {
    convite: '{nome}, acompanho pessoas que construíram patrimônio relevante por conta própria e buscam uma visão independente sobre ele. Sou das Relações Institucionais da Altum Wealth — vamos conectar?',
    1: `{nome}, obrigada pela conexão. Sou Sofia Mendes, das Relações Institucionais da Altum Wealth — trabalho com Hariton Andrade, advisor independente no modelo fiduciário, sem comissão de produto.
